...
const ComputeResourceAppsTableMenuBar2: FunctionComponent<ComputeResourceAppsTableMenuBarProps> = ({selectedAppNames, onAddApp, onDeleteApps, onEditApp}) => {
...
export default ComputeResourceAppsTableMenuBar2